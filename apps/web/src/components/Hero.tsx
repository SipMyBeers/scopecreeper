...
import { Terminal, Globe, FileText, ChevronRight } from "lucide-react";
...
export default function Hero() {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="relative flex-1 z-10 flex flex-col items-center justify-start overflow-y-auto px-4 py-10 font-retro custom-scrollbar">
        ...
        <div className="relative flex flex-col items-center max-w-4xl w-full text-center">
          ...
          {/* The Payload Drop Zone (Moved up) */}
          <motion.div 
            className="w-full max-w-xl pixel-border p-1 bg-black/40 backdrop-blur-sm mb-12"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-start">
            ...
            <div className="relative w-full aspect-[4/5] flex items-center justify-center">
              <motion.div
                ...
                className="w-full max-w-[280px] h-full pixel-border bg-black/80 relative flex items-center justify-center overflow-hidden"
              >
                {/* The Vortex Screen */}
          ...
          {/* Footer Metrics */}
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 opacity-40 text-xs uppercase tracking-[0.2em] w-full">
